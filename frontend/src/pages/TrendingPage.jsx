      ...
      {items.map((it, i) => {
        ...
        return (
          ...
          >
            ...
            {it.image_url
              ? <img src={imageMedium(it.image_url)} alt="" loading="lazy" decoding="async" style={{ width: 56, height: 56, borderRadius: "var(--radius-sm)", objectFit: "cover", flexShrink: 0 }} />
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      {items.map((rv) => {
        ...
        return (
          ...
          >
            {target?.image_url
              ? <img src={imageMedium(target.image_url)} alt="" loading="lazy" decoding="async" style={{ width: 48, height: 48, borderRadius: "var(--radius-sm)", objectFit: "cover", flexShrink: 0 }} />
