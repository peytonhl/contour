...
export function AlbumSearch({ label, accentColor, onSelect, selected }) {
  ...
  function handleChange(e) {
    ...
    debounceRef.current = setTimeout(async () => {
      setLoading(true);
      try {
        const data = await api.searchAlbums(val);
        setResults(data);
        setOpen(true);
      } catch {
        setResults([]);
      ...
      {selected ? (
        ...
        <div style={styles.inputRow}>
          <input
            style={{
              ...styles.input,
              borderColor: open ? accentColor : "var(--border)",
            }}
            ...
            <div style={styles.dropdown}>
              {results.map((album) => (
                <div
                  ...
                  onMouseDown={() => handleSelect(album)}
                >
                  {album.image_url ? (
                    <img src={album.image_url} alt="" style={styles.thumb} />
                  ) : (
                    <div style={styles.thumbPlaceholder} />
                  )}
                  <div style={styles.itemText}>
                    <span style={styles.itemName}>{album.name}</span>
                    <span style={styles.itemArtist}>
